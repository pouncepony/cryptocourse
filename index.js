...
'redis://:pf7bb5b345735fe847f224dec25b7453cb6387e56a43c5e9907b1e0204c4afc24@ec2-34-192-135-49.compute-1.amazonaws.com:12329'
...
const syncWithRootState = () => {
    ...
    request({url: `${ROOT_NODE_ADDRESS}/api/transaction-pool-map`}, (error, response, body) => {
        if(!error && response.statusCode === 200) {
            ...
            console.log('resplace transaction pool map on sync with', rootTransactionPoolMap);
